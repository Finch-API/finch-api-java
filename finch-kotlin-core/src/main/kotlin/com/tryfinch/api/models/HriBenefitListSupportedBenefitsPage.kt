...
class HriBenefitListSupportedBenefitsPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HriBenefitListSupportedBenefitsPage &&
    ...
    override fun toString() =
        "HriBenefitListSupportedBenefitsPage{benefitsService=$benefitsService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return items().isEmpty()
    }

    fun getNextPageParams(): HriBenefitListSupportedBenefitsParams? {
        return null
    }

    fun getNextPage(): HriBenefitListSupportedBenefitsPage? {
    ...
    constructor(
        ...
        override fun toString() =
            "HriBenefitListSupportedBenefitsPage.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: HriBenefitListSupportedBenefitsPage,
