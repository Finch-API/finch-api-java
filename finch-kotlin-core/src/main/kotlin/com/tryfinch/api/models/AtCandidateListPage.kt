...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AtCandidateListPage &&
    ...
    override fun toString() =
        "AtCandidateListPage{candidatesService=$candidatesService, params=$params, response=$response}"
    ...
    fun getNextPageParams(): AtCandidateListParams? {
        if (!hasNextPage()) {
            return null
        }

        return AtCandidateListParams.builder()
            .from(params)
            .offset((paging().offset() ?: 0) + candidates().count())
            .build()
    }

    fun getNextPage(): AtCandidateListPage? {
    ...
    constructor(
        ...
        override fun toString() =
            "AtCandidateListPage.Response{paging=$paging, candidates=$candidates, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AtCandidateListPage,
    ) : Sequence<Candidate> {
