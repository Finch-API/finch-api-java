...
[![Maven Central](https://img.shields.io/maven-central/v/com.tryfinch.api/finch-java)](https://central.sonatype.com/artifact/com.tryfinch.api/finch-java/0.31.1)
...
```kotlin
implementation("com.tryfinch.api:finch-java:0.31.1")
```
