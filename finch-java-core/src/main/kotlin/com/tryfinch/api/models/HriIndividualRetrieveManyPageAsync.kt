...
private constructor(
    ...
    fun getNextPage(): CompletableFuture<Optional<HriIndividualRetrieveManyPageAsync>> {
    ...
    constructor(
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<HriIndividualRetrieveManyPageAsync>>.forEach(
