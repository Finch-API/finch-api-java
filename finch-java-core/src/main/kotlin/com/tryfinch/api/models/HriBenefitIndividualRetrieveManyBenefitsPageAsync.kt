...
class HriBenefitIndividualRetrieveManyBenefitsPageAsync
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HriBenefitIndividualRetrieveManyBenefitsPageAsync &&
    ...
    override fun toString() =
        "HriBenefitIndividualRetrieveManyBenefitsPageAsync{individualsService=$individualsService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return items().isEmpty()
    }

    fun getNextPageParams(): Optional<HriBenefitIndividualRetrieveManyBenefitsParams> {
        return Optional.empty()
    }

    fun getNextPage():
        CompletableFuture<Optional<HriBenefitIndividualRetrieveManyBenefitsPageAsync>> {
    ...
    constructor(
        ...
        override fun toString() =
            "HriBenefitIndividualRetrieveManyBenefitsPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: HriBenefitIndividualRetrieveManyBenefitsPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<HriBenefitIndividualRetrieveManyBenefitsPageAsync>>
                .forEach(
