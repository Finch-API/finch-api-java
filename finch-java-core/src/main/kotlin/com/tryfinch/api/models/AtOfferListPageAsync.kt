...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AtOfferListPageAsync &&
    ...
    override fun toString() =
        "AtOfferListPageAsync{offersService=$offersService, params=$params, response=$response}"
    ...
    fun getNextPage(): CompletableFuture<Optional<AtOfferListPageAsync>> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(offersService: OfferServiceAsync, params: AtOfferListParams, response: Response) =
    ...
    constructor(
        ...
        override fun toString() =
            "AtOfferListPageAsync.Response{paging=$paging, offers=$offers, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AtOfferListPageAsync,
    ) {

        fun forEach(action: Predicate<Offer>, executor: Executor): CompletableFuture<Void> {
            fun CompletableFuture<Optional<AtOfferListPageAsync>>.forEach(
