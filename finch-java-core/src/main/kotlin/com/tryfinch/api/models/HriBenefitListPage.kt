...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HriBenefitListPage &&
    ...
    override fun toString() =
        "HriBenefitListPage{benefitsService=$benefitsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<HriBenefitListPage> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(benefitsService: BenefitService, params: HriBenefitListParams, response: Response) =
            HriBenefitListPage(
                benefitsService,
                params,
                response,
    ...
    constructor(
        ...
        override fun toString() =
            "HriBenefitListPage.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: HriBenefitListPage,
