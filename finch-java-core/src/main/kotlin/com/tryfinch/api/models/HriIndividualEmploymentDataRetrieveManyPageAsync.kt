...
private constructor(
    ...
    fun getNextPage():
        CompletableFuture<Optional<HriIndividualEmploymentDataRetrieveManyPageAsync>> {
    ...
    constructor(
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<HriIndividualEmploymentDataRetrieveManyPageAsync>>
                .forEach(
