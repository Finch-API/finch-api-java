...
class Introspection @JsonCreator private constructor(
     ...
     * created for this connection.
     */
    fun customerName(): Optional<String> = Optional.ofNullable(customerName.getNullable("customer_name"))
    ...
    class AuthenticationMethod @JsonCreator private constructor(
        ...
        fun connectionStatus(): Optional<ConnectionStatus> = Optional.ofNullable(connectionStatus.getNullable("connection_status"))
        ...
        class ConnectionStatus @JsonCreator private constructor(
            ...
            fun status(): Optional<ConnectionStatusType> = Optional.ofNullable(status.getNullable("status"))
