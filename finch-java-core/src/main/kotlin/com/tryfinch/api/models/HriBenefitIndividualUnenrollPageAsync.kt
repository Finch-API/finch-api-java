...
class HriBenefitIndividualUnenrollPageAsync
private constructor(
    private val individualsService: IndividualServiceAsync,
    private val params: HriBenefitIndividualUnenrollParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HriBenefitIndividualUnenrollPageAsync &&
    ...
    override fun toString() =
        "HriBenefitIndividualUnenrollPageAsync{individualsService=$individualsService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return items().isEmpty()
    }

    fun getNextPageParams(): Optional<HriBenefitIndividualUnenrollParams> {
        return Optional.empty()
    }

    fun getNextPage(): CompletableFuture<Optional<HriBenefitIndividualUnenrollPageAsync>> {
    ...
    constructor(
        ...
        override fun toString() =
            "HriBenefitIndividualUnenrollPageAsync.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: HriBenefitIndividualUnenrollPageAsync,
    ) {
        ...
        fun forEach(
            ...
            fun CompletableFuture<Optional<HriBenefitIndividualUnenrollPageAsync>>.forEach(
