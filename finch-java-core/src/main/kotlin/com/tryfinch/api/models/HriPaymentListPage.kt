...
class HriPaymentListPage
private constructor(
    private val paymentsService: PaymentService,
    private val params: HriPaymentListParams,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HriPaymentListPage &&
    ...
    override fun toString() =
        "HriPaymentListPage{paymentsService=$paymentsService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return items().isEmpty()
    }

    fun getNextPageParams(): Optional<HriPaymentListParams> {
        return Optional.empty()
    }

    fun getNextPage(): Optional<HriPaymentListPage> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(paymentsService: PaymentService, params: HriPaymentListParams, response: Response) =
            HriPaymentListPage(
                paymentsService,
                params,
                response,
    ...
    constructor(
        ...
        override fun toString() =
            "HriPaymentListPage.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: HriPaymentListPage,
    ) : Iterable<Payment> {
