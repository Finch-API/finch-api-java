...
private constructor(
    ...
    private constructor(
         ...
         *     @Override
         *     public Optional<String> visitIndividualBenefit(InnerIndividualBenefit individualBenefit) {
         *         return Optional.of(individualBenefit.toString());
         *     }
         *
         *     // ...
         *
        ...
        private constructor(
            ...
            private constructor(
                 ...
                 * import java.util.Optional;
                 *
                 * Optional<String> result = companyContribution.accept(new CompanyContribution.Visitor<Optional<String>>() {
                 *     @Override
                 *     public Optional<String> visitFixed(CompanyContributionFixed fixed) {
            ...
            private constructor(
                 ...
                 * import java.util.Optional;
                 *
                 * Optional<String> result = employeeDeduction.accept(new EmployeeDeduction.Visitor<Optional<String>>() {
                 *     @Override
                 *     public Optional<String> visitContributionFixed(EmployeeDeductionContributionFixed contributionFixed) {
                 *         return Optional.of(contributionFixed.toString());
                 *     }
                 *
                 *     // ...
                 *
