...
constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HriPaymentListParams &&
    ...
    override fun toString() =
        "HriPaymentListParams{startDate=$startDate, endDate=$endDate, additionalQueryParams=$additionalQueryParams, additionalHeaders=$additionalHeaders}"
    ...
    class Builder {
        ...
        @JvmSynthetic
        internal fun from(hriPaymentListParams: HriPaymentListParams) = apply {
            this.startDate = hriPaymentListParams.startDate
            this.endDate = hriPaymentListParams.endDate
            additionalQueryParams(hriPaymentListParams.additionalQueryParams)
            additionalHeaders(hriPaymentListParams.additionalHeaders)
        }
        ...
        fun build(): HriPaymentListParams =
            HriPaymentListParams(
