...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AtApplicationListPage &&
    ...
    override fun toString() =
        "AtApplicationListPage{applicationsService=$applicationsService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<AtApplicationListPage> {
    ...
    constructor(
        ...
        override fun toString() =
            "AtApplicationListPage.Response{paging=$paging, applications=$applications, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AtApplicationListPage,
