...
class HriIndividualEmploymentDataRetrieveManyPage
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is HriIndividualEmploymentDataRetrieveManyPage &&
    ...
    override fun toString() =
        "HriIndividualEmploymentDataRetrieveManyPage{employmentDataService=$employmentDataService, params=$params, response=$response}"

    fun hasNextPage(): Boolean {
        return responses().isEmpty()
    }

    fun getNextPageParams(): Optional<HriIndividualEmploymentDataRetrieveManyParams> {
        return Optional.empty()
    }

    fun getNextPage(): Optional<HriIndividualEmploymentDataRetrieveManyPage> {
    ...
    constructor(
        ...
        override fun toString() =
            "HriIndividualEmploymentDataRetrieveManyPage.Response{responses=$responses, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: HriIndividualEmploymentDataRetrieveManyPage,
