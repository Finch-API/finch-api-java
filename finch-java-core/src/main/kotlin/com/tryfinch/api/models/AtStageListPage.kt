...
private constructor(
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AtStageListPage &&
    ...
    override fun toString() =
        "AtStageListPage{stagesService=$stagesService, params=$params, response=$response}"
    ...
    fun getNextPage(): Optional<AtStageListPage> {
    ...
    companion object {
        ...
        @JvmStatic
        fun of(stagesService: StageService, params: AtStageListParams, response: Response) =
            AtStageListPage(
                stagesService,
                params,
                response,
    ...
    constructor(
        ...
        override fun toString() =
            "AtStageListPage.Response{items=$items, additionalProperties=$additionalProperties}"
    ...
    class AutoPager
    constructor(
        private val firstPage: AtStageListPage,
    ) : Iterable<Stage> {
