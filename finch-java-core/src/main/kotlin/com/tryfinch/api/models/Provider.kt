...
class Provider @JsonCreator private constructor(
    ...
    fun authenticationMethods(): Optional<List<AuthenticationMethod>> = Optional.ofNullable(authenticationMethods.getNullable("authentication_methods"))
    ...
    fun displayName(): Optional<String> = Optional.ofNullable(displayName.getNullable("display_name"))
    ...
    fun mfaRequired(): Optional<Boolean> = Optional.ofNullable(mfaRequired.getNullable("mfa_required"))
    ...
    class AuthenticationMethod @JsonCreator private constructor(
         ...
         */
        fun benefitsSupport(): Optional<BenefitsSupport> = Optional.ofNullable(benefitsSupport.getNullable("benefits_support"))

        /** The supported data fields returned by our HR and payroll endpoints */
        fun supportedFields(): Optional<SupportedFields> = Optional.ofNullable(supportedFields.getNullable("supported_fields"))
        ...
        class Builder internal constructor() {
             ...
             * supported, the property will be null
             */
            fun benefitsSupport(benefitsSupport: Optional<BenefitsSupport>) = benefitsSupport(benefitsSupport.getOrNull())
            ...
            /** The supported data fields returned by our HR and payroll endpoints */
            fun supportedFields(supportedFields: Optional<SupportedFields>) = supportedFields(supportedFields.getOrNull())
        ...
        class SupportedFields @JsonCreator private constructor(
            ...
            fun company(): Optional<SupportedCompanyFields> = Optional.ofNullable(company.getNullable("company"))

            fun directory(): Optional<SupportedDirectoryFields> = Optional.ofNullable(directory.getNullable("directory"))

            fun employment(): Optional<SupportedEmploymentFields> = Optional.ofNullable(employment.getNullable("employment"))

            fun individual(): Optional<SupportedIndividualFields> = Optional.ofNullable(individual.getNullable("individual"))

            fun payGroup(): Optional<SupportedPayGroupFields> = Optional.ofNullable(payGroup.getNullable("pay_group"))

            fun payStatement(): Optional<SupportedPayStatementFields> = Optional.ofNullable(payStatement.getNullable("pay_statement"))

            fun payment(): Optional<SupportedPaymentFields> = Optional.ofNullable(payment.getNullable("payment"))
            ...
            class SupportedCompanyFields @JsonCreator private constructor(
                ...
                fun accounts(): Optional<Accounts> = Optional.ofNullable(accounts.getNullable("accounts"))

                fun departments(): Optional<Departments> = Optional.ofNullable(departments.getNullable("departments"))
                ...
                fun legalName(): Optional<Boolean> = Optional.ofNullable(legalName.getNullable("legal_name"))

                fun locations(): Optional<Locations> = Optional.ofNullable(locations.getNullable("locations"))

                fun primaryEmail(): Optional<Boolean> = Optional.ofNullable(primaryEmail.getNullable("primary_email"))

                fun primaryPhoneNumber(): Optional<Boolean> = Optional.ofNullable(primaryPhoneNumber.getNullable("primary_phone_number"))
                ...
                class Accounts @JsonCreator private constructor(
                    ...
                    fun accountName(): Optional<Boolean> = Optional.ofNullable(accountName.getNullable("account_name"))

                    fun accountNumber(): Optional<Boolean> = Optional.ofNullable(accountNumber.getNullable("account_number"))

                    fun accountType(): Optional<Boolean> = Optional.ofNullable(accountType.getNullable("account_type"))

                    fun institutionName(): Optional<Boolean> = Optional.ofNullable(institutionName.getNullable("institution_name"))

                    fun routingNumber(): Optional<Boolean> = Optional.ofNullable(routingNumber.getNullable("routing_number"))
                ...
                class Entity @JsonCreator private constructor(
                    ...
                    fun subtype(): Optional<Boolean> = Optional.ofNullable(subtype.getNullable("subtype"))
                ...
                class Locations @JsonCreator private constructor(
                    ...
                    fun country(): Optional<Boolean> = Optional.ofNullable(country.getNullable("country"))
                    ...
                    fun postalCode(): Optional<Boolean> = Optional.ofNullable(postalCode.getNullable("postal_code"))
            ...
            class SupportedDirectoryFields @JsonCreator private constructor(
                ...
                fun individuals(): Optional<Individuals> = Optional.ofNullable(individuals.getNullable("individuals"))
                ...
                class Individuals @JsonCreator private constructor(
                    ...
                    fun department(): Optional<Boolean> = Optional.ofNullable(department.getNullable("department"))

                    fun firstName(): Optional<Boolean> = Optional.ofNullable(firstName.getNullable("first_name"))

                    fun isActive(): Optional<Boolean> = Optional.ofNullable(isActive.getNullable("is_active"))

                    fun lastName(): Optional<Boolean> = Optional.ofNullable(lastName.getNullable("last_name"))

                    fun manager(): Optional<Manager> = Optional.ofNullable(manager.getNullable("manager"))

                    fun middleName(): Optional<Boolean> = Optional.ofNullable(middleName.getNullable("middle_name"))
                ...
                class Paging @JsonCreator private constructor(
                    ...
                    fun offset(): Optional<Boolean> = Optional.ofNullable(offset.getNullable("offset"))
            ...
            class SupportedEmploymentFields @JsonCreator private constructor(
                ...
                fun classCode(): Optional<Boolean> = Optional.ofNullable(classCode.getNullable("class_code"))

                fun customFields(): Optional<Boolean> = Optional.ofNullable(customFields.getNullable("custom_fields"))
                ...
                fun employmentStatus(): Optional<Boolean> = Optional.ofNullable(employmentStatus.getNullable("employment_status"))

                fun endDate(): Optional<Boolean> = Optional.ofNullable(endDate.getNullable("end_date"))

                fun firstName(): Optional<Boolean> = Optional.ofNullable(firstName.getNullable("first_name"))

                fun income(): Optional<Income> = Optional.ofNullable(income.getNullable("income"))

                fun incomeHistory(): Optional<Boolean> = Optional.ofNullable(incomeHistory.getNullable("income_history"))
                ...
                fun startDate(): Optional<Boolean> = Optional.ofNullable(startDate.getNullable("start_date"))
                ...
                class Income @JsonCreator private constructor(
                    ...
                    fun amount(): Optional<Boolean> = Optional.ofNullable(amount.getNullable("amount"))

                    fun currency(): Optional<Boolean> = Optional.ofNullable(currency.getNullable("currency"))
            ...
            class SupportedIndividualFields @JsonCreator private constructor(
                ...
                fun encryptedSsn(): Optional<Boolean> = Optional.ofNullable(encryptedSsn.getNullable("encrypted_ssn"))

                fun ethnicity(): Optional<Boolean> = Optional.ofNullable(ethnicity.getNullable("ethnicity"))
                ...
                fun phoneNumbers(): Optional<PhoneNumbers> = Optional.ofNullable(phoneNumbers.getNullable("phone_numbers"))

                fun preferredName(): Optional<Boolean> = Optional.ofNullable(preferredName.getNullable("preferred_name"))

                fun residence(): Optional<Residence> = Optional.ofNullable(residence.getNullable("residence"))
            ...
            class SupportedPayGroupFields @JsonCreator private constructor(
                ...
                fun individualIds(): Optional<Boolean> = Optional.ofNullable(individualIds.getNullable("individual_ids"))

                fun name(): Optional<Boolean> = Optional.ofNullable(name.getNullable("name"))

                fun payFrequencies(): Optional<Boolean> = Optional.ofNullable(payFrequencies.getNullable("pay_frequencies"))
            ...
            class SupportedPayStatementFields @JsonCreator private constructor(
                ...
                fun payStatements(): Optional<PayStatements> = Optional.ofNullable(payStatements.getNullable("pay_statements"))
                ...
                class PayStatements @JsonCreator private constructor(
                    ...
                    fun earnings(): Optional<Earnings> = Optional.ofNullable(earnings.getNullable("earnings"))

                    fun employeeDeductions(): Optional<EmployeeDeductions> = Optional.ofNullable(employeeDeductions.getNullable("employee_deductions"))

                    fun employerContributions(): Optional<EmployerContributions> = Optional.ofNullable(employerContributions.getNullable("employer_contributions"))

                    fun grossPay(): Optional<Boolean> = Optional.ofNullable(grossPay.getNullable("gross_pay"))

                    fun individualId(): Optional<Boolean> = Optional.ofNullable(individualId.getNullable("individual_id"))

                    fun netPay(): Optional<Boolean> = Optional.ofNullable(netPay.getNullable("net_pay"))

                    fun paymentMethod(): Optional<Boolean> = Optional.ofNullable(paymentMethod.getNullable("payment_method"))

                    fun taxes(): Optional<Taxes> = Optional.ofNullable(taxes.getNullable("taxes"))

                    fun totalHours(): Optional<Boolean> = Optional.ofNullable(totalHours.getNullable("total_hours"))
            ...
            class SupportedPaymentFields @JsonCreator private constructor(
                ...
                fun companyDebit(): Optional<Boolean> = Optional.ofNullable(companyDebit.getNullable("company_debit"))

                fun debitDate(): Optional<Boolean> = Optional.ofNullable(debitDate.getNullable("debit_date"))

                fun employeeTaxes(): Optional<Boolean> = Optional.ofNullable(employeeTaxes.getNullable("employee_taxes"))

                fun employerTaxes(): Optional<Boolean> = Optional.ofNullable(employerTaxes.getNullable("employer_taxes"))
                ...
                fun payDate(): Optional<Boolean> = Optional.ofNullable(payDate.getNullable("pay_date"))

                fun payFrequencies(): Optional<Boolean> = Optional.ofNullable(payFrequencies.getNullable("pay_frequencies"))

                fun payGroupIds(): Optional<Boolean> = Optional.ofNullable(payGroupIds.getNullable("pay_group_ids"))
