...
private constructor(
    ...
    private constructor(
        ...
        private constructor(
            ...
            fun _457(): Optional<BenefitSupportType> = Optional.ofNullable(_457.getNullable("457"))

            fun _401k(): Optional<BenefitSupportType> =
                Optional.ofNullable(_401k.getNullable("401k"))

            fun _401kRoth(): Optional<BenefitSupportType> =
                Optional.ofNullable(_401kRoth.getNullable("401k_roth"))

            fun _401kLoan(): Optional<BenefitSupportType> =
                Optional.ofNullable(_401kLoan.getNullable("401k_loan"))

            fun _403b(): Optional<BenefitSupportType> =
                Optional.ofNullable(_403b.getNullable("403b"))

            fun _403bRoth(): Optional<BenefitSupportType> =
                Optional.ofNullable(_403bRoth.getNullable("403b_roth"))

            fun _457Roth(): Optional<BenefitSupportType> =
                Optional.ofNullable(_457Roth.getNullable("457_roth"))

            fun s125Medical(): Optional<BenefitSupportType> =
                Optional.ofNullable(s125Medical.getNullable("s125_medical"))

            fun s125Dental(): Optional<BenefitSupportType> =
                Optional.ofNullable(s125Dental.getNullable("s125_dental"))

            fun s125Vision(): Optional<BenefitSupportType> =
                Optional.ofNullable(s125Vision.getNullable("s125_vision"))

            fun hsaPre(): Optional<BenefitSupportType> =
                Optional.ofNullable(hsaPre.getNullable("hsa_pre"))

            fun hsaPost(): Optional<BenefitSupportType> =
                Optional.ofNullable(hsaPost.getNullable("hsa_post"))

            fun fsaMedical(): Optional<BenefitSupportType> =
                Optional.ofNullable(fsaMedical.getNullable("fsa_medical"))

            fun fsaDependentCare(): Optional<BenefitSupportType> =
                Optional.ofNullable(fsaDependentCare.getNullable("fsa_dependent_care"))

            fun simpleIra(): Optional<BenefitSupportType> =
                Optional.ofNullable(simpleIra.getNullable("simple_ira"))

            fun simple(): Optional<BenefitSupportType> =
                Optional.ofNullable(simple.getNullable("simple"))

            fun commuter(): Optional<BenefitSupportType> =
                Optional.ofNullable(commuter.getNullable("commuter"))

            fun customPostTax(): Optional<BenefitSupportType> =
                Optional.ofNullable(customPostTax.getNullable("custom_post_tax"))

            fun customPreTax(): Optional<BenefitSupportType> =
            ...
            fun validate(): BenefitsSupport = apply {
                if (!validated) {
                    _457().map { it.validate() }
                    _401k().map { it.validate() }
                    _401kRoth().map { it.validate() }
                    _401kLoan().map { it.validate() }
                    _403b().map { it.validate() }
                    _403bRoth().map { it.validate() }
                    _457Roth().map { it.validate() }
        ...
        private constructor(
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    fun employerDeductions(): Optional<EmployerDeductions> =
