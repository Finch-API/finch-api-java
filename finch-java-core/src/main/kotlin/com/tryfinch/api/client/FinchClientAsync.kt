...
/**
 * A client for interacting with the Finch REST API asynchronously. You can also
...
interface FinchClientAsync {
    ...
    /**
     * A view of [FinchClientAsync] that provides access to raw HTTP responses for each
     * method.
     */
