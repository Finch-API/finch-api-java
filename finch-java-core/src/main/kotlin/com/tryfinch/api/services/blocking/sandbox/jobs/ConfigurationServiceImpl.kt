...
class ConfigurationServiceImpl internal constructor(
    private val clientOptions: ClientOptions,

) : ConfigurationService {

    private val withRawResponse: ConfigurationService.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }

    override fun withRawResponse(): ConfigurationService.WithRawResponse = withRawResponse

    override fun retrieve(params: SandboxJobConfigurationRetrieveParams, requestOptions: RequestOptions): List<SandboxJobConfiguration> =
        // get /sandbox/jobs/configuration
        withRawResponse().retrieve(params, requestOptions).parse()

    override fun update(params: SandboxJobConfigurationUpdateParams, requestOptions: RequestOptions): SandboxJobConfiguration =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun retrieve(params: SandboxJobConfigurationRetrieveParams, requestOptions: RequestOptions): HttpResponseFor<List<SandboxJobConfiguration>> {
        ...
        override fun update(params: SandboxJobConfigurationUpdateParams, requestOptions: RequestOptions): HttpResponseFor<SandboxJobConfiguration> {
          val request = HttpRequest.builder()
