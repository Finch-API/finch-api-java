...
class BenefitServiceAsyncImpl internal constructor(
    ...
    override fun create(params: HrisBenefitCreateParams, requestOptions: RequestOptions): CompletableFuture<CreateCompanyBenefitsResponse> =
        // post /employer/benefits
        withRawResponse().create(params, requestOptions).thenApply { it.parse() }

    override fun retrieve(params: HrisBenefitRetrieveParams, requestOptions: RequestOptions): CompletableFuture<CompanyBenefit> =
        // get /employer/benefits/{benefit_id}
        withRawResponse().retrieve(params, requestOptions).thenApply { it.parse() }

    override fun update(params: HrisBenefitUpdateParams, requestOptions: RequestOptions): CompletableFuture<UpdateCompanyBenefitResponse> =
        // post /employer/benefits/{benefit_id}
        withRawResponse().update(params, requestOptions).thenApply { it.parse() }

    override fun list(params: HrisBenefitListParams, requestOptions: RequestOptions): CompletableFuture<HrisBenefitListPageAsync> =
        // get /employer/benefits
        withRawResponse().list(params, requestOptions).thenApply { it.parse() }

    override fun listSupportedBenefits(params: HrisBenefitListSupportedBenefitsParams, requestOptions: RequestOptions): CompletableFuture<HrisBenefitListSupportedBenefitsPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: HrisBenefitCreateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CreateCompanyBenefitsResponse>> {
        ...
        override fun retrieve(params: HrisBenefitRetrieveParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<CompanyBenefit>> {
          val request = HttpRequest.builder()
        ...
        override fun update(params: HrisBenefitUpdateParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<UpdateCompanyBenefitResponse>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.POST)
            .addPathSegments("employer", "benefits", params.getPathParam(0))
            .body(json(clientOptions.jsonMapper, params._body()))
        ...
        override fun list(params: HrisBenefitListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HrisBenefitListPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
            .addPathSegments("employer", "benefits")
            .build()
        ...
        override fun listSupportedBenefits(params: HrisBenefitListSupportedBenefitsParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HrisBenefitListSupportedBenefitsPageAsync>> {
          val request = HttpRequest.builder()
            .method(HttpMethod.GET)
