...
class PaymentServiceAsyncImpl internal constructor(
    ...
    override fun list(params: HrisPaymentListParams, requestOptions: RequestOptions): CompletableFuture<HrisPaymentListPageAsync> =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun list(params: HrisPaymentListParams, requestOptions: RequestOptions): CompletableFuture<HttpResponseFor<HrisPaymentListPageAsync>> {
