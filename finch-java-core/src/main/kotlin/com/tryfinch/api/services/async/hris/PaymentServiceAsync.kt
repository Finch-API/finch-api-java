...
interface PaymentServiceAsync {
    ...
    /** @see [list] */
    fun list(params: HrisPaymentListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HrisPaymentListPageAsync>
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun list(params: HrisPaymentListParams): CompletableFuture<HttpResponseFor<HrisPaymentListPageAsync>> =
            list(
              params, RequestOptions.none()
            )
        ...
        /** @see [list] */
        @MustBeClosed
        fun list(params: HrisPaymentListParams, requestOptions: RequestOptions = RequestOptions.none()): CompletableFuture<HttpResponseFor<HrisPaymentListPageAsync>>
    }
}
