...
class PayrollServiceAsyncImpl internal constructor(
    private val clientOptions: ClientOptions,

) : PayrollServiceAsync {

    private val withRawResponse: PayrollServiceAsync.WithRawResponse by lazy { WithRawResponseImpl(clientOptions) }
    ...
    class WithRawResponseImpl internal constructor(
        ...
        private val payGroups: PayGroupServiceAsync.WithRawResponse by lazy { PayGroupServiceAsyncImpl.WithRawResponseImpl(clientOptions) }
