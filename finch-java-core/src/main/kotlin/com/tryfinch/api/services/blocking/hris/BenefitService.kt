...
interface BenefitService {
     ...
     */
    fun register(): RegisterCompanyBenefitResponse = register(HrisBenefitRegisterParams.none())
    ...
    fun register(
        params: HrisBenefitRegisterParams = HrisBenefitRegisterParams.none()
    ): RegisterCompanyBenefitResponse = register(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun register(): HttpResponseFor<RegisterCompanyBenefitResponse> =
        ...
        fun register(
            params: HrisBenefitRegisterParams = HrisBenefitRegisterParams.none()
        ): HttpResponseFor<RegisterCompanyBenefitResponse> = register(params, RequestOptions.none())
