...
class EmploymentServiceImpl internal constructor(
    ...
    override fun update(params: SandboxEmploymentUpdateParams, requestOptions: RequestOptions): EmploymentUpdateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun update(params: SandboxEmploymentUpdateParams, requestOptions: RequestOptions): HttpResponseFor<EmploymentUpdateResponse> {
