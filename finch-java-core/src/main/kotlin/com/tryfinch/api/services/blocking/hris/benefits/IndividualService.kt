...
interface IndividualService {
     ...
     */
    fun enrollMany(benefitId: String): EnrolledIndividualBenefitResponse =
    ...
    ): EnrolledIndividualBenefitResponse = enrollMany(benefitId, params, RequestOptions.none())
    ...
    fun enrollMany(
        params: HrisBenefitIndividualEnrollManyParams
    ): EnrolledIndividualBenefitResponse = enrollMany(params, RequestOptions.none())
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun enrollMany(benefitId: String): HttpResponseFor<EnrolledIndividualBenefitResponse> =
            enrollMany(benefitId, HrisBenefitIndividualEnrollManyParams.none())
