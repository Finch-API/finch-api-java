...
class PaymentServiceImpl internal constructor(
    ...
    override fun create(params: SandboxPaymentCreateParams, requestOptions: RequestOptions): PaymentCreateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: SandboxPaymentCreateParams, requestOptions: RequestOptions): HttpResponseFor<PaymentCreateResponse> {
