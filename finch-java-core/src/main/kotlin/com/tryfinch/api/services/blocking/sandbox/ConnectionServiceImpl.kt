...
class ConnectionServiceImpl internal constructor(
    ...
    override fun create(params: SandboxConnectionCreateParams, requestOptions: RequestOptions): ConnectionCreateResponse =
    ...
    class WithRawResponseImpl internal constructor(
        ...
        override fun create(params: SandboxConnectionCreateParams, requestOptions: RequestOptions): HttpResponseFor<ConnectionCreateResponse> {
