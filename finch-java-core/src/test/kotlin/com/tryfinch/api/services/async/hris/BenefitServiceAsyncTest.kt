...
class BenefitServiceAsyncTest {
    ...
    fun create() {
      ...
      val createCompanyBenefitsResponseFuture = benefitServiceAsync.create(HrisBenefitCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val companyBenefitFuture = benefitServiceAsync.retrieve(HrisBenefitRetrieveParams.builder()
    ...
    fun update() {
      ...
      val updateCompanyBenefitResponseFuture = benefitServiceAsync.update(HrisBenefitUpdateParams.builder()
          .benefitId("benefit_id")
          .description("description")
          .build())
