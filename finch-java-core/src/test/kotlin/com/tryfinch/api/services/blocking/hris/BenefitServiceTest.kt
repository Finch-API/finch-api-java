...
class BenefitServiceTest {
    ...
    fun create() {
      ...
      val createCompanyBenefitsResponse = benefitService.create(HrisBenefitCreateParams.builder()
    ...
    fun retrieve() {
      ...
      val companyBenefit = benefitService.retrieve(HrisBenefitRetrieveParams.builder()
    ...
    fun update() {
      ...
      val updateCompanyBenefitResponse = benefitService.update(HrisBenefitUpdateParams.builder()
          .benefitId("benefit_id")
          .description("description")
          .build())
