...
class SessionServiceAsyncTest {
    ...
    fun new_() {
      ...
      val responseFuture = sessionServiceAsync.new_(ConnectSessionNewParams.builder()
          .customerId("x")
          .customerName("x")
    ...
    fun reauthenticate() {
      ...
      val responseFuture = sessionServiceAsync.reauthenticate(ConnectSessionReauthenticateParams.builder()
