...
class EmploymentUpdateResponseTest {
    ...
    fun createEmploymentUpdateResponse() {
      ...
      assertThat(employmentUpdateResponse.customFields().get()).containsExactly(EmploymentUpdateResponse.CustomField.builder()
          .name("name")
          .value(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(employmentUpdateResponse.department()).contains(EmploymentUpdateResponse.Department.builder()
          .name("name")
          .build())
      assertThat(employmentUpdateResponse.employment()).contains(EmploymentUpdateResponse.Employment.builder()
          .subtype(EmploymentUpdateResponse.Employment.Subtype.FULL_TIME)
          .type(EmploymentUpdateResponse.Employment.Type.EMPLOYEE)
          .build())
      assertThat(employmentUpdateResponse.employmentStatus()).contains(EmploymentUpdateResponse.EmploymentStatus.ACTIVE)
      ...
      assertThat(employmentUpdateResponse.income()).contains(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
          .build())
      assertThat(employmentUpdateResponse.incomeHistory().get()).containsExactly(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
      ...
      assertThat(employmentUpdateResponse.location()).contains(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
          ...
          .state("state")
          .build())
      assertThat(employmentUpdateResponse.manager()).contains(EmploymentUpdateResponse.Manager.builder()
          .id("id")
          .build())
