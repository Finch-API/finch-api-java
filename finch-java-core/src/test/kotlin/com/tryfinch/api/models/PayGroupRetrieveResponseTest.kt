...
class PayGroupRetrieveResponseTest {
    ...
    fun createPayGroupRetrieveResponse() {
      val payGroupRetrieveResponse = PayGroupRetrieveResponse.builder()
      ...
      assertThat(payGroupRetrieveResponse.individualIds()).containsExactly("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
      assertThat(payGroupRetrieveResponse.name()).isEqualTo("name")
      assertThat(payGroupRetrieveResponse.payFrequencies()).containsExactly(PayGroupRetrieveResponse.PayFrequency.ANNUALLY)
    }
}
