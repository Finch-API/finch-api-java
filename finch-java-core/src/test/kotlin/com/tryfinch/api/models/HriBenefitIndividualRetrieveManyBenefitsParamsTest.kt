...
class HriBenefitIndividualRetrieveManyBenefitsParamsTest {

    @Test
    fun createHriBenefitIndividualRetrieveManyBenefitsParams() {
        HriBenefitIndividualRetrieveManyBenefitsParams.builder()
            .benefitId("string")
            .individualIds(
