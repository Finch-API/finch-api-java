...
class SandboxCompanyUpdateParamsTest {
    ...
    fun body() {
      ...
      assertNotNull(body)
      assertThat(body.accounts()).contains(listOf(SandboxCompanyUpdateParams.Account.builder()
          .accountName("account_name")
          .accountNumber("account_number")
          .accountType(SandboxCompanyUpdateParams.Account.AccountType.CHECKING)
          .institutionName("institution_name")
          .routingNumber("routing_number")
          .build()))
      assertThat(body.departments()).contains(listOf(SandboxCompanyUpdateParams.Department.builder()
          .name("name")
          .parent(SandboxCompanyUpdateParams.Department.Parent.builder()
              .name("name")
              .build())
      ...
      assertThat(body.entity()).contains(SandboxCompanyUpdateParams.Entity.builder()
          .subtype(SandboxCompanyUpdateParams.Entity.Subtype.S_CORPORATION)
          .type(SandboxCompanyUpdateParams.Entity.Type.LLC)
          .build())
      assertThat(body.legalName()).contains("legal_name")
      assertThat(body.locations()).contains(listOf(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
    ...
    fun bodyWithoutOptionalFields() {
      ...
      assertNotNull(body)
      assertThat(body.accounts()).contains(listOf(SandboxCompanyUpdateParams.Account.builder().build()))
