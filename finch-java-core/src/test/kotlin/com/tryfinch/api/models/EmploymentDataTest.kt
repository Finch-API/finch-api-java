...
class EmploymentDataTest {
    ...
    fun createEmploymentData() {
      ...
      assertThat(employmentData.customFields().get()).containsExactly(EmploymentData.CustomField.builder()
          .name("name")
          .value(JsonValue.from(mapOf<String, Any>()))
          .build())
      assertThat(employmentData.department()).contains(EmploymentData.Department.builder()
          .name("name")
          .build())
      assertThat(employmentData.employment()).contains(EmploymentData.Employment.builder()
          .subtype(EmploymentData.Employment.Subtype.FULL_TIME)
          .type(EmploymentData.Employment.Type.EMPLOYEE)
          .build())
      assertThat(employmentData.employmentStatus()).contains(EmploymentData.EmploymentStatus.ACTIVE)
      assertThat(employmentData.endDate()).contains("end_date")
      assertThat(employmentData.firstName()).contains("first_name")
      assertThat(employmentData.income()).contains(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
          .build())
      assertThat(employmentData.incomeHistory().get()).containsExactly(Income.builder()
          .amount(0L)
          .currency("currency")
          .effectiveDate("effective_date")
          .unit(Income.Unit.YEARLY)
      ...
      assertThat(employmentData.location()).contains(Location.builder()
          .city("city")
          .country("country")
          .line1("line1")
          .line2("line2")
          ...
          .state("state")
          .build())
      assertThat(employmentData.manager()).contains(EmploymentData.Manager.builder()
          .id("id")
          .build())
